...
if __name__ == '__main__':
    ...
    for pathfile_id, pathfile in pathfiles.items():
        ...
        #initial_alphabet_opt = d['initial_alphabet_opt']
        num_of_elements = d['rx_array_size'] * d['tx_array_size']
        ...
        #if  num_of_elements == 4 and initial_alphabet_opt == 'katsavounidis':
        #    #trial_info = {'norm': norm}
        #    print (norm)
        #    occurences.append(pathfile)
        if  num_of_elements == 16: # and initial_alphabet_opt == 'katsavounidis':
            if norm > max_norm:
                max_norm = norm
                best_treined_codebook = pathfile
    ...
    #print (f'# of occurences: {len(occurences)}')
    print (best_treined_codebook)
    #print(f'******************************************')
    #print(f'n-value: {n}')
