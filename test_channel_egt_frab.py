...
if __name__ == "__main__":
    ...
    for ch in channels:
        ...
        print (f'rt_f_egt_frab_b4.norm: {norm(rt_f_egt_frab_b4)}')
        ...
        print (f'rt_f_egt_frab_b3.norm: {norm(rt_f_egt_frab_b3)}')
        rt_bf_gain_egt_frab_b3 = bf_gain_test(ch, rt_f_egt_frab_b3, rt_w_opt)
        bf_gain_rt_egt_frab_b3.append(rt_bf_gain_egt_frab_b3)



        b = 2
        rt_f_egt_frab_b2 = get_frab(rt_f_egt, b)
        print (f'rt_f_egt_frab_b2.norm: {norm(rt_f_egt_frab_b2)}')
        rt_bf_gain_egt_frab_b2 = bf_gain_test(ch, rt_f_egt_frab_b2, rt_w_opt)
        bf_gain_rt_egt_frab_b2.append(rt_bf_gain_egt_frab_b2)
        ...
        bf_gain_rt_egt_frab_b1.append(rt_bf_gain_egt_frab_b1)
    ...
    plt.plot(bf_gain_rt_egt_frab_b4, label='RT BF gain (EGT) -- frab -- b=4', linestyle='--')
    plt.plot(bf_gain_rt_egt_frab_b3, label='RT BF gain (EGT) -- frab -- b=3', linestyle='--')
    plt.plot(bf_gain_rt_egt_frab_b2, label='RT BF  gain (EGT) -- frab -- b=2', linestyle='--')
    plt.plot(bf_gain_rt_egt_frab_b1, label='RT BF gain (EGT) -- frab -- b=1', linestyle='--')
