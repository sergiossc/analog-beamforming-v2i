import sys
sys.path.append(r'/home/snow/current/analog-beamforming-v2i/lib/mimo')
sys.path.append(r'/home/snow/current/analog-beamforming-v2i/lib/utils')
import numpy as np
...
num_rx = 16
rx_array = PartitionedArray(num_rx, d, wavelength, "UPA") # configuracao da antena de recepcao 
